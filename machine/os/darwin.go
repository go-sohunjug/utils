...
var macMachineData Information
...
func (mac MacMachine) GetMacSysInfo() (data Information, err error) {
	var cmd *exec.Cmd
...
func (MacMachine) macXmlToData(xmlcontent string) (Information, error) {
	x := macXmlStruct{}
